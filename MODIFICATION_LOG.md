...
- 分支：`main`
- 變更摘要：調整地圖投影輸出的局部放大視覺化，放大圖只框選匹配區域、保留單一加粗黃色外框與黃色連線，車輛位置 X 改為紅色；重新產生 frame 51 與 frame 161 的地圖座標與流程總覽範例圖。
- 影響範圍：`scripts/localize_vehicles.py`、`vehicle_localization_outputs/frame_000051/`、`vehicle_localization_outputs/frame_000161/`、`.gitignore`、`MODIFICATION_LOG.md`
